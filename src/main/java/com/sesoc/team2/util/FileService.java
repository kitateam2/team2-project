...
public class FileService {
	...
	public static String saveFile(MultipartFile mfile, String uploadPath) {
		...
		//원본 파일명을 읽었어
		String post_originalfile = mfile.getOriginalFilename();
		...
		//원본 파일의 확장자
		String ext;
		int lastIndex = post_originalfile.lastIndexOf('.');
		//확장자가 없는 경우
		if (lastIndex == -1) {
			ext = "";
		}
		//확장자가 있는 경우
			...
			ext = "." + post_originalfile.substring(lastIndex + 1);
		}
