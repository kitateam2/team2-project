...
public class BlogPost {
	...
	public String getPost_book_isbn() {
		return post_book_isbn;
	}


	public void setPost_book_isbn(String post_book_isbn) {
		this.post_book_isbn = post_book_isbn;
	}


	public String getPost_book_title() {
		return post_book_title;
	}


	public void setPost_book_title(String post_book_title) {
		this.post_book_title = post_book_title;
	}
