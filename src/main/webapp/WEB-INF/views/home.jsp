...
<body>
    ...
    <section class="space-bottom-3">
        <header class="mb-4 container">
            <h2 class="font-size-7 text-center">신간도서</h2>
        </header>
        <div class="container">
                    ...
                    <div class="product product__card border-right">
                        <div class="media p-md-6 p-4 d-block d-md-flex">
                            <div class="woocommerce-loop-product__thumbnail mb-4 mb-md-0">
                                <a href="../shop/single-product-v1.html" class="d-block"><img src="https://placehold.it/200x327" class="attachment-shop_catalog size-shop_catalog wp-post-image d-block mx-auto" alt="image-description"></a>
                            </div>
