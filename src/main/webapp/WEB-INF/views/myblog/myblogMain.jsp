	                            ...
	                            <div id="Categories" class="widget p-4 border">
	                                <div id="Heading22">
	                                    <a class="d-flex align-items-center justify-content-between collapse-link text-dark" href="#"
	                                        ...
	                                        <h3 class="title mb-0 font-weight-medium font-size-3">나의 블로그:)</h3>
                            ...
                            <div id="RecentPosts" class="widget p-4 border">
                                <div id="Heading23">
                                    <a class="d-flex align-items-center justify-content-between collapse-link text-dark" href="#"
                                        ...
                                        <h3 class="title font-weight-medium font-size-3 mb-0">팔로잉(${countFollowing})</h3>
                            ...
                            <div id="RecentPosts" class="widget p-4 border">
                                <div id="Heading23">
                                    <a class="d-flex align-items-center justify-content-between collapse-link text-dark" href="#"
                                        ...
                                        <h3 class="title font-weight-medium font-size-3 mb-0">팔로워(${countFollowed})</h3>
