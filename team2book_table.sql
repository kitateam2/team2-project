...
DROP TABLE BOOK_SUB CASCADE CONSTRAINTS;
...
DROP SEQUENCE book_email_no_seq;
...
CREATE SEQUENCE book_email_no_seq;
...
(
	book_email varchar2(100) DEFAULT '0' NOT NULL,
	book_email_no number NOT NULL,
	PRIMARY KEY (book_email)
);
